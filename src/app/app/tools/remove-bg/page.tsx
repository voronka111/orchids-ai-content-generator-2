...
function RemoveBgToolContent() {
  ...
  const EXAMPLE_IMAGE = "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/project-uploads/010102a2-9a78-497c-a40c-16883620b037/removebg-1768346852348.png?width=8000&height=8000&resize=contain";
  ...
  const handleProcess = async () => {
    ...
    toast.success(language === "ru" ? "Фон успешно удален!" : "Background successfully removed!");
  };
            ...
            <Link href="/app" className="p-2.5 rounded-2xl hover:bg-white/10 transition-colors border border-white/5">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground font-black uppercase tracking-[0.2em] opacity-40">
                  {language === "ru" ? "Автоматическое удаление фона с помощью ИИ" : "Automatic background removal with AI"}
                </p>
              </div>
          </div>
