...
import { LucideIcon, Sparkles, Image, Video, Music, ArrowRight, Star, Globe, Zap, Shield, Cpu, ExternalLink, Scissors, Wand2, Maximize, Eraser, Smile, Sun, Palette, ChevronDown } from "lucide-react";
...
function SpotlightGrid() {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 z-0 pointer-events-none overflow-hidden h-[1000px]">
      <div
...
function Marquee() {
  const models = ["Stable Diffusion 3.5", "Midjourney v6.1", "DALL-E 3", "Luma Dream Machine", "Suno v5", "Kling AI", "Nano Banana Pro"];
  return (
    <div className="relative py-6 overflow-hidden">
      <div className="flex whitespace-nowrap animate-marquee">
        ...
        <div key={i} className="flex gap-12 items-center px-6">
            {models.map((model) =>
          <span key={model} className="text-xs sm:text-sm font-bold text-white/40 uppercase tracking-[0.2em]">
                {model}
              </span>
            )}
            </div>
...
function ParallaxImageGrid() {
  ...
  const { scrollYProgress } = useScroll({
    ...
    const images = [
    { src: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=800&q=80", y: useTransform(scrollYProgress, [0, 1], [0, -150]), size: "large", position: "left" },
    { src: "https://images.unsplash.com/photo-1633167606207-d840b5070fc2?w=800&q=80", y: useTransform(scrollYProgress, [0, 1], [0, 100]), size: "medium", position: "center-top" },
    { src: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1200&q=80", y: useTransform(scrollYProgress, [0, 1], [0, -50]), size: "extra-large", position: "center" },
    { src: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&q=80", y: useTransform(scrollYProgress, [0, 1], [0, -200]), size: "small", position: "right" },
  { src: "https://images.unsplash.com/photo-1614850523296-d8c1af93d400?w=800&q=80", y: useTransform(scrollYProgress, [0, 1], [0, 150]), size: "medium", position: "bottom-left" },
  { src: "https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?w=800&q=80", y: useTransform(scrollYProgress, [0, 1], [0, -120]), size: "large", position: "bottom-right" },
  { src: "https://images.unsplash.com/photo-1614728263952-84ea256f9679?w=800&q=80", y: useTransform(scrollYProgress, [0, 1], [0, 80]), size: "small", position: "left-center" },
  { src: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=800&q=80", y: useTransform(scrollYProgress, [0, 1], [0, -180]), size: "medium", position: "right-center" },
  { src: "https://images.unsplash.com/photo-1620121692029-d088224ddc74?w=800&q=80", y: useTransform(scrollYProgress, [0, 1], [0, 120]), size: "small", position: "bottom-center" }];
    ...
    const getAnimationProps = (position: string, i: number) => {
      ...
      return { initial, whileInView, transition: { duration, delay, ease } };
    };
...
function FeaturesTabs() {
  ...
  const tabs = [
    { 
      ...
      description: language === "ru" ? "Делайте уникальные изображения любого стиля" : "Create unique images in any style",
    ...
    { 
      ...
      description: language === "ru" ? "Превращайте идеи в динамичные видеоролики" : "Transform ideas into dynamic videos",
    ...
    { 
      ...
      description: language === "ru" ? "Генерируйте музыку и звуковые эффекты" : "Generate music and sound effects",
...
function ToolCard({ icon: Icon, title, description, image, hoverImage }: {icon: any;title: string;description: string;image: string;hoverImage: string;}) {
  ...
  return (
    <div
      ...
      <h3 className="text-2xl font-black mb-2 group-hover:text-[#6F00FF] transition-colors uppercase tracking-tight leading-none">{title}</h3>
...
function ToolsScroll() {
  ...
  const tools = language === "ru" ? [
    { icon: Image, title: "Магия кисти", description: "Превращайте слова в визуальные шедевры за секунды", image: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1633167606207-d840b5070fc2?w=800&q=80" },
    { icon: Video, title: "Живые кадры", description: "Вдохните жизнь в статичные изображения одним кликом", image: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1614850523296-d8c1af93d400?w=800&q=80" },
    { icon: Wand2, title: "Сверхчеткость", description: "Раскройте каждую деталь в безупречном 4K разрешении", image: "https://images.unsplash.com/photo-1614728263952-84ea256f9679?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=800&q=80" },
    { icon: Eraser, title: "Чистый холст", description: "Мгновенная изоляция объектов для ваших лучших идей", image: "https://images.unsplash.com/photo-1620121692029-d088224ddc74?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?w=800&q=80" },
    { icon: Maximize, title: "Без границ", description: "Достраивайте реальность за пределами кадра силой ИИ", image: "https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&q=80" }
  ] : [
    { icon: Image, title: "Brush Magic", description: "Transform words into visual masterpieces in seconds", image: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1633167606207-d840b5070fc2?w=800&q=80" },
    { icon: Video, title: "Living Frames", description: "Breathe life into static images with a single click", image: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1614850523296-d8c1af93d400?w=800&q=80" },
    { icon: Wand2, title: "Ultra Clarity", description: "Reveal every detail in flawless 4K resolution", image: "https://images.unsplash.com/photo-1614728263952-84ea256f9679?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=800&q=80" },
    { icon: Eraser, title: "Clean Canvas", description: "Instant object isolation for your best ideas", image: "https://images.unsplash.com/photo-1620121692029-d088224ddc74?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?w=800&q=80" },
    { icon: Maximize, title: "No Limits", description: "Extend reality beyond the frame with AI power", image: "https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?w=800&q=80", hoverImage: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&q=80" }
  ];
      ...
      <div className="py-32 overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-6 mb-16">
          <h2 className="text-4xl sm:text-7xl tracking-tighter uppercase mb-4 leading-none">
            ...
            <span className="font-bold">{language === "ru" ? "без ограничений" : "without limits"}</span>
          </h2>
          <p className="text-xl text-white/40 max-w-2xl font-medium">{language === "ru" ? "Все необходимые инструменты для профессиональной работы с контентом в одном месте" : "All the tools you need for professional content creation in one place"}</p>
        </div>
...
function HiggsfieldGrid() {
  ...
  const items = [
  { id: 1, category: "cinema", size: "large", img: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=800&q=80" },
  { id: 2, category: "art", size: "medium", img: "https://images.unsplash.com/photo-1633167606207-d840b5070fc2?w=800&q=80" },
  { id: 3, category: "anime", size: "small", img: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&q=80" },
  { id: 4, category: "3d", size: "medium", img: "https://images.unsplash.com/photo-1614850523296-d8c1af93d400?w=800&q=80" },
  { id: 5, category: "cinema", size: "small", img: "https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?w=800&q=80" },
  { id: 6, category: "art", size: "large", img: "https://images.unsplash.com/photo-1614728263952-84ea256f9679?w=800&q=80" },
  { id: 7, category: "anime", size: "medium", img: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=800&q=80" },
  { id: 8, category: "3d", size: "small", img: "https://images.unsplash.com/photo-1620121692029-d088224ddc74?w=800&q=80" }];
      ...
      <div className="columns-1 sm:columns-2 lg:columns-4 xl:columns-5 gap-4 space-y-4">
        ...
        <motion.div
          ...
          className="relative rounded-2xl overflow-hidden group border border-black/5">
            ...
            <img src={item.img} alt="" className="w-full h-auto transition-transform duration-700 group-hover:scale-105" />
...
function NavDropdown({ label, items, language, isLight }: {label: string;items: any[];language: string;isLight?: boolean;}) {
  ...
  return (
    ...
    >
      <DropdownMenu open={open} onOpenChange={setOpen}>
        ...
        >
          {items.map((item) =>
            <DropdownMenuItem key={item.href} asChild className="rounded-xl focus:bg-white/10 focus:text-white cursor-pointer p-0">
                <Link href={item.href} className="flex items-center gap-3 w-full p-3 group/item">
...
export function LandingPage() {
  ...
  ["смешную картинку", "видео из фото", "песню про друзей", "логотип бренда", "3D персонажа"] :
  ["funny image", "video from photo", "song about friends", "brand logo", "3D character"];

  const createItems = [
  { href: "/app/create/image", label: { ru: "Изображение", en: "Image" }, description: { ru: "Генерация картинок", en: "Generate images" }, icon: Image },
  { href: "/app/create/video", label: { ru: "Видео", en: "Video" }, description: { ru: "Создание анимаций", en: "Create animations" }, icon: Video },
  { href: "/app/create/audio", label: { ru: "Аудио", en: "Audio" }, description: { ru: "Музыка и речь", en: "Music and speech" }, icon: Music }];


  const toolItems = [
  { href: "/app/tools/enhance", label: { ru: "Улучшить", en: "Enhance" }, description: { ru: "HD качество", en: "HD quality" }, icon: Wand2 },
  { href: "/app/tools/expand", label: { ru: "Расширить", en: "Expand" }, description: { ru: "Достроить края", en: "Outpaint edges" }, icon: Maximize },
  { href: "/app/tools/inpaint", label: { ru: "Заменить", en: "Inpaint" }, description: { ru: "Изменить детали", en: "Change details" }, icon: Scissors },
  { href: "/app/tools/remove-bg", label: { ru: "Удалить фон", en: "Remove BG" }, description: { ru: "Прозрачный фон", en: "Transparent BG" }, icon: Eraser }];


  const appItems = [
  { href: "/app/apps/face-swap", label: { ru: "Лица", en: "Face Swap" }, description: { ru: "Замена лиц", en: "Swap faces" }, icon: Smile },
  { href: "/app/apps/relight", label: { ru: "Свет", en: "Relight" }, description: { ru: "Изменить освещение", en: "Change lighting" }, icon: Sun },
  { href: "/app/apps/stylist", label: { ru: "Стилист", en: "Stylist" }, description: { ru: "Перенос стиля", en: "Style transfer" }, icon: Palette }];
              ...
              <div className={`max-w-[1440px] mx-auto px-6 h-16 flex items-center justify-between relative z-10 ${isHeaderLight ? "text-black" : "text-white"}`}>
                <div className="flex items-center gap-4">
                  ...
                  <div className="hidden lg:flex items-center gap-1">
                    ...
                    <NavDropdown label={language === "ru" ? "Приложения" : "Apps"} items={appItems} language={language} isLight={isHeaderLight} />
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl border transition-all text-[10px] font-bold uppercase tracking-widest flex items-center gap-2 backdrop-blur-md ${
                    isHeaderLight ? "border-black/5 bg-black/10 text-black hover:bg-black/15" : "border-white/5 bg-white/10 text-white hover:bg-white/15"
                  }`}>
      ...
      <main className="relative">
            ...
            <motion.div
              ...
              className="text-center mb-12">
                      ...
                      <h1 className="text-4xl sm:text-6xl md:text-[90px] tracking-tighter mb-6 leading-[1.05]">
                        <span className="font-black uppercase tracking-[0.25em] inline-block mb-2">{language === "ru" ? "Сделай" : "Create"}</span> <br />
                        <span className="font-normal text-white/70 tracking-tight"><AnimatedTitle phrases={phrases} /></span>
                      </h1>
                ...
                <div className="lg:flex lg:flex-col lg:items-end">
                  <div className="w-full sm:w-auto text-left">
                    ...
                    <ul className="flex flex-col gap-6">
                      <li><Link href="/app/create/image" className="text-white hover:text-[#6F00FF] transition-colors text-sm font-bold uppercase tracking-wider">{language === "ru" ? "Сделать" : "Create"}</Link></li>
                      <li><Link href="/app/tools/enhance" className="text-white hover:text-[#6F00FF] transition-colors text-sm font-bold uppercase tracking-wider">{language === "ru" ? "Инструменты" : "Tools"}</Link></li>
                      <li><Link href="/app/apps/face-swap" className="text-white hover:text-[#6F00FF] transition-colors text-sm font-bold uppercase tracking-wider">{language === "ru" ? "Приложения" : "Apps"}</Link></li>
                    </ul>
                  </div>
                </div>
                <div className="lg:flex lg:flex-col lg:items-end">
        ...
        <div className="flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-x-12 gap-y-4">
            <Link href="#" className="text-white/10 hover:text-white transition-colors text-[10px] uppercase tracking-[0.2em] font-bold">{language === "ru" ? "Политика конфиденциальности" : "Privacy Policy"}</Link>
            <Link href="#" className="text-white/10 hover:text-white transition-colors text-[10px] uppercase tracking-[0.2em] font-bold">{language === "ru" ? "Условия использования" : "Terms of Use"}</Link>
          </div>
        </div>
      </div>
        </div>
