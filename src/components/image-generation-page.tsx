...
export function ImageGenerationPage() {
    ...
    return (
        <div className="max-w-full mx-auto pb-40 relative">
            ...
            <div className={`sticky top-0 z-40 px-6 py-4 flex items-center justify-between gap-4 pointer-events-none transition-opacity ${selectedImage ? 'opacity-0' : 'opacity-100'}`}>
